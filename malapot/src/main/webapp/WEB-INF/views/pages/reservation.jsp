...
<link rel="stylesheet" href="//code.jquery.com/ui/1.10.4/themes/base/jquery-ui.css">
			...
			$("#submit")
					.click(
							function doCookieSetUp() {
								let reservation = Cookies.get("reservation") != undefined ? JSON
										.parse(decodeURIComponent(Cookies
												.get("reservation")))
										: {};
